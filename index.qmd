...
1. Keep using `iris` and use it as an opportunity to learn/teach about racism & racist history in statistics.
...
## Penguins in the wild {background-image="img/penguins-wilder.jpg" background-size="contain"}
...
::: column
![Map of Antarctica by Kristin Gorman](img/antarctic-modis.jpg){fig-alt="Map of Antarctica by Kristin Gorman" fig-align="center"}
...
- Cedric Scherer for [this plot](https://www.behance.net/gallery/101517403/Bill-Dimensions-of-Penguins)

- Silvia Canelon for her [great tutorial](https://www.silviacanelon.com/talk/2020-tour-of-the-tidyverse/)
